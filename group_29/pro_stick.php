					...
					<div class="portfolio-item graphic">
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div style="width:400px;margin:auto;overflow:hidden"> <!-- 這個最外圍的容器div寬度為900px，每張圖寬為300px，所以只顯示3張，剩下的圖超出容器隱藏起來 -->
                                    <div class="imgs portfolio-item" style="width:5000px;"><!--這個div的作用是讓所有的圖片都排在同一水平上，這樣子切換的時候效果會更好(太小 圖片會往下跑)-->
                                    <img src="picture/Product/stick.webp" style="width:400px;"/><!--這裡的圖片換上到時候自己對應的圖片-->
                                    <img src="picture/Product/stick2.webp" style="width:400px;"/>
                                    <img src="picture/Product/stick3.webp" style="width:400px;"/>
                                    <img src="#" alt="沒有囉"/>
                                    </div>
                                </div>
