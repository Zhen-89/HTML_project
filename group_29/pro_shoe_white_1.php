    ...
    <head>
        ...
        <script>
            var cot=0;//設置一個計數器，初始值為0；作用是用來監聽點擊切換的時候哪一個圖片應該隱藏或者顯示
                function nex(){
                if(cot<=5){// 幾個圖片，就要調整 cot2 的 max 值
						...
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div style="width:400px;margin:auto;overflow:hidden"> <!-- 這個最外圍的容器div寬度為400px，將每張圖寬調為400px，所以只顯示1張，剩下的圖超出容器隱藏起來 -->
                                    ...
                                    <img src="picture/Product/show_white_1_.jpg" style="width:400px;"/><!--這裡的圖片換上到時候自己對應的圖片-->
                                    <img src="picture/Product/show_white_1_2.jpg" style="width:400px;"/>
                                    <img src="picture/Product/show_white_1_3.jpg" style="width:400px;"/>
                                    <img src="picture/Product/show_white_1_4.jpg" style="width:400px;"/>
                                    <img src="picture/Product/show_white_1_5.jpg" style="width:400px;"/>
                                    <img src="picture/Product/show_white_1_6.jpg" style="width:400px;"/>
                                    <img src="picture/Product/show_white_1_7.jpg" style="width:400px;"/>
                                    </div>
                                </div>
					...
					<div class="portfolio-item graphic">
                        ...
                        <div class="area-title text-center pro_intro" style="text-align:left">
                            <div>
                                 ● 商品簡介
                                <div class="pro_text">
                                    女撥水加工有機棉舒適基本便鞋 柔白23.0cm<br>
採用對足弓有良好支撐力的鞋墊，使足部不易感到疲憊。使用有機棉製成。
                                </div><!---->
                            </div>
                            <div>
                                ● 商品規格
                                <div class="pro_text">
                                    鞋面：棉100%(使用有機棉100%)。<br>鞋底材質：橡膠鞋底
                                </div>
                            </div>
                            <div>
                                ● 售價
