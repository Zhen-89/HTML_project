						...
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div style="width:400px;margin:auto;overflow:hidden"> <!-- 這個最外圍的容器div寬度為400px，將每張圖寬調為400px，所以只顯示1張，剩下的圖超出容器隱藏起來 -->
                                    ...
                                    <img src="picture/Product/coat_gray.jpg" style="width:400px;"/><!--這裡的圖片換上到時候自己對應的圖片-->
                                    <img src="picture/Product/coat_gray2.jpg" style="width:400px;"/>
                                    <img src="picture/Product/coat_gray3.webp" style="width:400px;"/>
                                    <img src="picture/Product/coat_gray4.webp" style="width:400px;"/>
                                    </div>
                                </div>
