...
('member', 'member123456', '1989/05/06', '王小明', 'allen@gmail.com', '041234567', '09876543212112 ', '彰化市行天宮125號', '1', 1),
...
(1, 11, '【男女適用】連帽外套', '1', 6),
(1, 11, '有機棉舒適休閒鞋', '1', 7),
(1, 11, '棉束口袋/文字 原色NONE', '1', 8),
(1, 11, '有機棉舒適基本便鞋', '1', 9),
(1, 11, '不易變形坐墊/方形/混淺棕', '1', 10),
(1, 11, 'PS5無線手柄', '1', 11),
(1, 11, 'IOT智慧冰箱', '3', 13);
...
(1, 11, '超商取貨(7-11)', '貨到付款', '152506', '出貨處理中', '0');
...
CREATE TABLE `product_list` (
  ...
  `describee` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `product_list` (`goods_No`, `goods_name`, `type`, `describee`, `specification`, `price`, `picture`) VALUES
(1, '日本原裝進口 不鏽鋼鑰匙圈', 'other', '金鍊鑰匙拉鍊,\r\n半圓開口更大更方便\r\n123', '材質 不鏽鋼\r\n尺寸 寬 2 X 2 公分\r\n製造國家 日本', 10000, 'picture/m-project1.jpg'),
(2, '無印良品 小杯杯', 'other', '底部設有高台容易拿取，容量稍大，\r\n方便盛裝更多食物。', '伊賀燒小缽/白釉/\r\n約直徑13×高5cm 約直徑13×高5cm/\r\n約300ml', 150, 'picture/project1.jpg'),
(3, '無印良品 小筷筷', 'other', '竹筷子10雙組 23cm 天然竹經高壓熱處理、質輕堅韌。', '竹筷子10雙組 23cm\r\n表面塗層：聚氨酯塗層基材種類：天然竹', 130, 'picture/Product/stick.webp'),
(4, '【男女適用】休閒衫', 'cloth', '有機棉混緊密編織裏毛連帽上衣 銀灰XXS~XS\r\n男女適用】保有裏毛素材舒適的肌膚觸感，高密度織法呈現出適度的硬挺感與厚度。使用有機棉製成。', '本體：棉72%(使用有機棉100%)、聚酯纖維28%。螺紋：棉82%(使用有機棉100%)、聚酯纖維18%。後領貼：棉100%(使用有機棉100%)', 1600, 'picture/Product/sweater_white.webp'),
(5, '有機棉舒適休閒鞋柔白', 'cloth', '撥水加工有機棉舒適休閒鞋柔白22.0cm 柔白22.0cm\r\n採用對足弓有良好支撐力的鞋墊，使足部不易感到疲憊。使用有機棉製成。', '鞋面：棉100%(使用有機棉100%)。\r\n鞋底材質：橡膠鞋底', 699, 'picture/Product/shoe_white.jpg'),
(6, '【男女適用】連帽外套', 'cloth', '有機棉混緊密編織裏毛拉鍊連帽外套 灰色XXS~XS\r\n【男女適用】保有裏毛素材舒適的肌膚觸感，高密度織法呈現出適度的硬挺感與厚度。使用有機棉製成。', '本體：棉72%(使用有機棉100%)、聚酯纖維28%。螺紋：棉82%(使用有機棉100%)、聚酯纖維18%。後領貼：棉100%(使用有機棉100%)', 899, 'picture/Product/coat_gray.jpg'),
(7, '有機棉舒適休閒鞋', 'cloth', '撥水加工有機棉舒適休閒鞋 黑色25.5cm\r\n採用對足弓有良好支撐力的鞋墊，使足部不易感到疲憊。使用有機棉製成。', '鞋面：棉100%(使用有機棉100%)。\r\n鞋底材質：橡膠鞋底', 699, 'picture/Product/shoe_black.webp'),
(8, '棉束口袋/文字 原色NONE', 'other', '數量限定，可作為禮物包裝可收納拖鞋或小物的束口袋也可當作收納袋。', '棉100% (使用100%有機棉)', 69, 'picture/Product/bag.webp'),
(9, '有機棉舒適基本便鞋', 'cloth', '女撥水加工有機棉舒適基本便鞋 柔白23.0cm\r\n採用對足弓有良好支撐力的鞋墊，使足部不易感到疲憊。使用有機棉製成。', '鞋面：棉100%(使用有機棉100%)。\r\n鞋底材質：橡膠鞋底', 699, 'picture/Product/show_white_1_.jpg'),
(10, '不易變形坐墊/方形/混淺棕', 'other', '改為縱向聚酯纖維，成型後反彈性佳的坐墊。', '表面面料:棉100% (使用100%有機棉)硬棉:聚酯纖維100%', 540, 'picture/Product/cushion.webp'),
(11, 'PS5無線手柄', 'game', '創新的 PS5 控制器，發掘更深度的遊戲體驗<br>刺激您的感官體驗', '<i>觸覺回饋：</i><br>&emsp;雙致動器取代傳統震動馬達，讓您在遊戲內行動時感受到物理回饋。<br>\r\n<i>自適應扳機：</i><br>&emsp;與遊戲中的裝備和環境互動時，能體驗到不同程度的力量和張力。<br>', 2180, 'picture\\Product\\controler1.webp'),
(12, 'PlayStation5', 'game', '超高速 SSD，實現疾如閃電的載入速度；觸覺回饋、自適應扳機、3D 音效支援與所有難以置信的新一代', '光線追蹤<br>&emsp;在支援的 PS5™ 遊戲中，每道光線都個別模擬生成，創造出栩栩如生的陰影與反光，為您帶來全新層次的沉浸式寫實體驗。\r\n<br><br>4K 電視遊戲<br>&emsp;在畫質令人驚豔的 4K 電視上，暢玩自己最喜愛的 PS5™ 遊戲。', 16000, 'picture\\Product\\ps5_2.jpg'),
(13, 'IOT智慧冰箱', 'appliance', '500公升一級能效玻璃四門變頻冰箱(翡翠白)', '-3℃微凍結<br>R600a環保新冷媒<br>IOT智慧家電<br>', 44927, 'picture/Product/refig1.jpg'),
(14, '車站時鐘 白', 'appliance', '沿用與日本車站、街頭時鐘相同的數字盤設計。造型簡約，可融入室內擺設環境。', '車站時鐘 白.寬31.5x深4.3x高22.5cm', 1990, 'picture\\Product\\clock1.webp');
