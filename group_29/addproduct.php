...
// // 資料庫查詢(送出查詢的SQL指令)
if ($result = mysqli_query($link, "SELECT * FROM product_list  ORDER BY goods_No DESC LIMIT 0 , 1 ")) {
...
if (isset($_POST['sell-name'])) {
    $sql = "INSERT INTO product_list VALUES ('" . ($rows+1) . "','" . $_POST['sell-name'] . "','" . $_POST['sell_type'] . "','" . $_POST['sell-introduction'] . "','" . $_POST['sell-sepcify'] . "','" . $_POST['sell-price'] . "','picture/Product/" . $imgname . "')";
...
<meta http-equiv="refresh" content="0;url=selllist.php">