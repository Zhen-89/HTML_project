						...
						<div class="portfolio-wrapper">
							<div class="portfolio-thumb">
								...
								<div style="width:400px;margin:auto;overflow:hidden"> <!-- 這個最外圍的容器div寬度為400px，將每張圖寬調為400px，所以只顯示1張，剩下的圖超出容器隱藏起來 -->
                                    ...
                                    <img src="picture/Product/sweater_white.webp" style="width:400px;"/><!--這裡的圖片換上到時候自己對應的圖片-->
                                    <img src="picture/Product/sweater_white2.webp" style="width:400px;"/>
                                    <img src="picture/Product/sweater_white3.webp" style="width:400px;"/>
                                    <img src="picture/Product/sweater_white4.webp" style="width:400px;"/>
                                    <img src="picture/Product/sweater_white5.jpg" style="width:400px;"/>
                                    <img src="#" alt="沒有囉"/>
                                    </div>
                                </div>
					...
					<div class="portfolio-item graphic">
                        ...
                        <div class="area-title text-center pro_intro" style="text-align:left">
                            <div>
                                 ● 商品簡介
                                <div class="pro_text">
                                    有機棉混緊密編織裏毛連帽上衣 銀灰XXS~XS<br>
                                    男女適用】保有裏毛素材舒適的肌膚觸感，高密度織法呈現出適度的硬挺感與厚度。使用有機棉製成。
                                </div><!---->
                            </div>
                            <div>
                                ● 商品規格
                                <div class="pro_text">
                                    本體：棉72%(使用有機棉100%)、聚酯纖維28%。螺紋：棉82%(使用有機棉100%)、聚酯纖維18%。後領貼：棉100%(使用有機棉100%)
                                </div>
                            </div>
                            <div>
                                ● 售價
